...
import { getCaptchaScriptUrl } from "./captchaUtils";
...
export const Captcha = React.forwardRef<CaptchaHandle, CaptchaProps>(function Captcha(
    { captchaType, siteKey, onVerify, onExpire },
    ref,
) {
    ...
    const resetCaptcha = useCallback(() => {
        ...
        switch (captchaType) {
            case "turnstile":
                if (typeof win.turnstile !== "undefined" && widgetIdRef.current !== null) {
            ...
            case "reCAPTCHA":
                ...
                break;
            case "hCaptcha":
                if (typeof win.hcaptcha !== "undefined" && widgetIdRef.current !== null) {
                ...
                case "turnstile":
                    if (typeof win.turnstile !== "undefined") {
                        ...
                        if (typeof turnstile.render === "function") {
                            widgetIdRef.current = (
                                turnstile.render as (container: HTMLElement, options: Record<string, unknown>) => string
                            )(captchaRef.current!, {
                                sitekey: siteKey,
                                theme: "dark",
                ...
                case "hCaptcha":
                    if (typeof win.hcaptcha !== "undefined") {
                        ...
                        if (typeof hcaptcha.render === "function") {
                            widgetIdRef.current = (
                                hcaptcha.render as (container: HTMLElement, options: Record<string, unknown>) => string
                            )(captchaRef.current!, {
                                sitekey: siteKey,
                                theme: "dark",
                                callback: handleVerify,
